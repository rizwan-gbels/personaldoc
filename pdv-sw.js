...
// GitHub Pages variant: the app is served as index.html, so the filename
// stays fixed across builds — only bump CACHE_NAME (e.g. pdv-v102 ->
// pdv-v103) on each new build so returning visitors pick up the update
// instead of a stale cache.
const CACHE_NAME = 'pdv-v105';
