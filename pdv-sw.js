...
// stays fixed across builds — only bump CACHE_NAME (e.g. pdv-v108 ->
// pdv-v109) on each new build so returning visitors pick up the update
// instead of a stale cache.
const CACHE_NAME = 'pdv-v109';
